...
map.getView().fit([-8282030.800166, 496367.936359, -8221553.288480, 540154.130340], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sistema de Integración Comercial y Logístico - SiCLO</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (228 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Sistema de Integración Comercial y Logístico<br />Este geovisor es la puerta de entrada a una plataforma diseñada para integrar, analizar y visualizar información estratégica comercial y logística en un entorno geoespacial unificado.';
            }
